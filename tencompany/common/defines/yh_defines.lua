...
NDefines.NMilitary.FIELD_MARSHAL_XP_RATIO = 1					-- xp gain ratio for army group leaders
...
NDefines.NAI.CARRIER_TASKFORCE_MAX_CARRIER_COUNT = 5
NDefines.NAI.CAPITAL_TASKFORCE_MAX_CAPITAL_COUNT = 10
NDefines.NAI.SCREEN_TASKFORCE_MAX_SHIP_COUNT = 15
NDefines.NAI.SUB_TASKFORCE_MAX_SHIP_COUNT = 20
NDefines.NAI.MIN_CAPITALS_FOR_CARRIER_TASKFORCE = 5
NDefines.NAI.CAPITALS_TO_CARRIER_RATIO = 2.0
